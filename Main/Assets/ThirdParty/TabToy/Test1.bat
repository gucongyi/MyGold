...
rem ..\tabtoy.exe --mode=exportorv2 --lan=zh_cn --binary_out=..\..\..\Hotfix\Tabtoy\GenerateClass\DataProxyConfig.bytes --combinename=Config %FILES%
..\tabtoy.exe --mode=exportorv2 --lan=zh_cn --binary_out=..\..\..\Bundles\TabtoyData\tabtoyData.bytes --combinename=Config %FILES%
